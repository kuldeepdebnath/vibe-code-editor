...
type TemplateId = "react" | "nextjs" | "express" | "vue" | "hono" | "angular";
type TemplateCategory = "frontend" | "backend" | "fullstack";
...
const templateMap: Record<TemplateId, TemplateType> = {
  react: "REACT",
  nextjs: "NEXTJS",
  express: "EXPRESS",
  vue: "VUE",
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => handleSelectTemplate(value as TemplateId)}
              >
                      ...
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                          ${
                            ...
                            ? "border-[#E93F3F] shadow-[0_0_0_1px_#E93F3F,0_8px_20_px_rgba(233,63,63,0.15)]"
